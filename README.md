...
- [Dev.to/JS] [From building to selling - EP.08](https://dev.to/twankrui/from-building-to-selling-ep08-1b4f)
- [Dev.to/JS] [Django vs React: Which Framework You Should Go For?](https://dev.to/gurpreet2030/django-vs-react-which-framework-you-should-go-for-1d2c)
- [Dev.to/JS] [Tutorial Upload File/Photo Ke Firebase Pada React Native](https://dev.to/putuekamulyana/tutorial-upload-filephoto-ke-firebase-pada-react-native-l87)
