...
- [Dev.to/JS] [Directly point to source code when referencing dependencies in monorepo](https://dev.to/rxliuli/directly-point-to-source-code-when-referencing-dependencies-in-monorepo-3lai)
- [Dev.to/JS] [Express for beginners](https://dev.to/tanvirfahimbd/express-for-beginners-47me)
- [Dev.to/JS] [Sending Text Messages with Javascript and Twilio](https://dev.to/codesphere/sending-text-messages-with-javascript-and-twilio-2hpp)
- [Dev.to/JS] [a flying quadcopter in three.js](https://dev.to/roman_guivan_17680f142e28/a-flying-quadcopter-in-threejs-10ha)
- [Dev.to/JS] [simple pendulum  javascript canvas | oop | physics](https://dev.to/shatud/simple-pendulum-javascript-canvas-oop-physics-4o0d)
- [Dev.to/JS] [1 line of code: How to convert \newlines to &lt;breaks /&gt;](https://dev.to/martinkr/1-line-of-code-how-to-convert-newlines-to-dg9)
- [Lifehacker] [Stop Using Round Measuring Spoons](https://lifehacker.com/stop-using-round-measuring-spoons-1848348945)
- [Dev.to/JS] [What is Temporal Dead Zone in JavaScript?](https://dev.to/codewithsnowbit/what-is-temporal-dead-zone-in-javascript-1p9j)
