...
- [Dev.to/JS] [Get Better With CSS By Building These Mini Projects 👨‍💻🦄](https://dev.to/rammcodes/get-better-with-css-by-building-these-mini-projects-5ggd)
- [Dev.to/JS] [[video course] Learn how to build apps with LiveChat Developer Platform](https://dev.to/livechat/video-course-learn-how-to-build-apps-with-livechat-developer-platform-2h4m)
- [Dev.to/JS] [HOW to Keep user&#39;s password safe in database](https://dev.to/rahulj9a/how-to-keep-users-password-safe-in-database-g0f)
