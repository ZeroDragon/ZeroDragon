...
- [Dev.to/JS] [Window mouse position hook in React](https://dev.to/coder4_life/window-mouse-position-hook-in-react-bhm)
- [Dev.to/JS] [Functional JS](https://dev.to/varenya/functional-js-1ee)
