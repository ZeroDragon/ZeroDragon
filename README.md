...
- [Dev.to/JS] [Best practises for loading environment variable in NextJS application](https://dev.to/dipakkr/best-practises-for-loading-environment-variable-in-nextjs-application-3hni)
