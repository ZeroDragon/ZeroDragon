...
<!-- TECH-POSTS:START -->
- [Dev.to/JS] [What is react hooks ?](https://dev.to/chatgptd/what-is-react-hooks--53g4)
- [Dev.to/JS] [What is ACID Transaction? ELI5](https://dev.to/iamcdmx/what-is-acid-transaction-eli5-4jjc)
- [Dev.to/JS] [How to Code a Website Using HTML &amp; CSS | Simple website using HTML and CSS with source code](https://dev.to/dailywebdesign/how-to-code-a-website-using-html-css-simple-website-using-html-and-css-with-source-code-5an2)
- [Dev.to/JS] [15-ES6++: Proxy In JavaScript](https://dev.to/hassanzohdy/15-es6-proxy-in-javascript-59o)
- [Dev.to/JS] [How to Make Responsive Agency Website Using HTML CSS JavaScript With Source Code](https://dev.to/dailywebdesign/how-to-make-responsive-agency-website-using-html-css-javascript-with-source-code-4pb0)
- [Dev.to/JS] [How to build NFT Marketplace website using HTML CSS JS with Source Code](https://dev.to/dailywebdesign/how-to-build-nft-marketplace-website-using-html-css-js-with-source-code-1adj)
- [Dev.to/JS] [.reverse&lpar;&rpar; | .split&lpar;&#39;&#39;&rpar; | .join&lpar;&#39;&#39;&rpar; and palindrome in JS Explained](https://dev.to/isabellaguran22/reverse-split-join-in-js-explained-18if)
- [Dev.to/JS] [How to Make a Responsive Education Website Using HTML CSS JavaScript With Source Code](https://dev.to/dailywebdesign/how-to-make-a-responsive-education-website-using-html-css-javascript-with-source-code-59bc)
- [Dev.to/JS] [How To Make a Cosmetic Website Using HTML CSS And JAVASCRIPT With Source Code](https://dev.to/dailywebdesign/how-to-make-a-cosmetic-website-using-html-css-and-javascript-with-source-code-1bcg)
- [Dev.to/JS] [Why is the Dashboard for Your Product so Important?](https://dev.to/shreyvijayvargiya/why-is-the-dashboard-for-your-product-so-important-1aj9)
- [Dev.to/JS] [How To Make a Tour and Travel Website Using HTML CSS And JAVASCRIPT With Source Code](https://dev.to/dailywebdesign/how-to-make-a-tour-and-travel-website-using-html-css-and-javascript-with-source-code-3el7)
- [Dev.to/JS] [How do I make a grocery shopping website Using HTML CSS And JAVASCRIPT With Source Code](https://dev.to/dailywebdesign/how-do-i-make-a-grocery-shopping-website-using-html-css-and-javascript-with-source-code-52ep)
