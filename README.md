...
- [Dev.to/JS] [How to Detect Screen Orientation Using JavaScript](https://dev.to/capscode/how-to-detect-screen-orientation-using-javascript-b0m)
- [Dev.to/JS] [Serverless Remix Sessions with Cloudflare Pages](https://dev.to/fllstck/serverless-remix-sessions-with-cloudflare-pages-4lpo)
