...
- [Dev.to/JS] [Supercharging your NodeJS server development with Visual Backend](https://dev.to/johnyeocx/supercharging-your-nodejs-server-development-with-visual-backend-28fk)
- [Dev.to/JS] [Weekend project](https://dev.to/sidwyn/weekend-project-5bb4)
- [Dev.to/JS] [How to create and invoke Supabase database functions](https://dev.to/devkiran/how-to-create-and-invoke-supabase-database-functions-5e5i)
