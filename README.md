...
- [Dev.to/JS] [Blog Engine with Fresh: Query Post Item](https://dev.to/sokhavuth/blog-engine-with-fresh-query-post-item-54d5)
- [Dev.to/JS] [Understanding Variable Scope in JavaScript](https://dev.to/anthonydev/understanding-variable-scope-in-javascript-111n)
