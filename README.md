...
<!-- TECH-POSTS:START -->
- [Dev.to/JS] [Live Coding with the Amplify UI team](https://dev.to/codingcatdev/live-coding-with-the-amplify-ui-team-jgj)
- [Dev.to/JS] [Git Your Build System Right](https://dev.to/codingcatdev/git-your-build-system-right-3pcj)
- [Dev.to/JS] [Slap Someone with Slack Commands](https://dev.to/codingcatdev/slap-someone-with-slack-commands-3db1)
- [Dev.to/JS] [Supabase, Next.js and Builder.io](https://dev.to/codingcatdev/supabase-nextjs-and-builderio-1h66)
- [Dev.to/JS] [Serverless API Load Tester](https://dev.to/ahmettkartal/serverless-api-load-tester-3if9)
- [Dev.to/JS] [JavaScript BOM | Windows Object &amp; Screen Object | Full Tutorial | JavaScript Tutorial for Beginners](https://dev.to/codingmadeeasy/javascript-bom-windows-object-screen-object-full-tutorial-javascript-tutorial-for-beginners-1l4i)
- [Dev.to/JS] [About React js](https://dev.to/gauravjanjvadiya/about-react-js-5boo)
