...
<!-- TECH-POSTS:START -->
- [Dev.to/JS] [🥇Counting Valleys - HackerRank Solution &lpar;Javascript&rpar; 🚀](https://dev.to/hokagedemehin/counting-valleys-hackerrank-solution-javascript-2cd8)
- [Dev.to/JS] [Finally Authenticating Rails Users with MetaMask](https://dev.to/q9/finally-authenticating-rails-users-with-metamask-3fj)
- [Dev.to/JS] [We are back! Hackathon - New prizes, Dates &amp; Donations for Ukraine](https://dev.to/vue-storefront/we-are-back-hackathon-new-prizes-dates-donations-for-ukraine-3642)
- [Dev.to/JS] [100 Days of Code Challenge](https://dev.to/marvinobig/100-days-of-code-challenge-13bo)
- [Dev.to/JS] [Most used DateUtils in Javascript](https://dev.to/urstrulyvishwak/most-used-dateutils-in-javascript-b7i)
- [Dev.to/JS] [Shallow Copying in JavaScript using Object Spread Operator](https://dev.to/muhammad_asif/shallow-copying-in-javascript-using-object-spread-operator-1a60)
- [Dev.to/JS] [An open source ecommerce platform for Nuxt.js](https://dev.to/medusajs/an-open-source-ecommerce-platform-for-nuxtjs-fnl)
