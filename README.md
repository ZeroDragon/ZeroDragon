...
- [Dev.to/JS] [Implementing XGPlayer in Ruby on Rails](https://dev.to/timnans/implementing-xgplayer-in-ruby-on-rails-4404)
- [Dev.to/JS] [Test horizontal scroll overflow on mobile devices with Cypress](https://dev.to/olaj/test-horizontal-scroll-overflow-on-mobile-devices-with-cypress-1ikc)
- [Dev.to/JS] [Javascript in&#39;s &amp; outs 1](https://dev.to/nash4253/javascript-ins-outs-1-2h43)
- [Dev.to/JS] [JavaScript concepts to remember](https://dev.to/brunoelo/javascript-concepts-to-remember-52eh)
