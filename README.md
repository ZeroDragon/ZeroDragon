...
- [Dev.to/JS] [HTML5 Javascript Canvas Collision](https://dev.to/spsoi/html5-javascript-canvas-collision-152e)
...
- [Dev.to/JS] [Arrow Functions vs Normal Functions](https://dev.to/thenerdydev/arrow-functions-vs-normal-functions-3djk)
- [Dev.to/JS] [Some cool little hacks I&#39;ve learned.](https://dev.to/wolfmath/some-cool-little-hacks-ive-learned-4i7e)
- [Dev.to/JS] [FullStack JWT Auth: Diving into SvelteKit - Login and Registration](https://dev.to/sirneij/fullstack-jwt-auth-diving-into-sveltekit-login-and-registration-10c2)
- [Dev.to/JS] [&#39;How to learn anything faster!&#39;](https://dev.to/khalidhossain/how-to-learn-anything-faster-18d4)
- [Dev.to/JS] [Use SvelteKit to create npm packages](https://dev.to/dreitzner/use-sveltekit-to-create-npm-packages-3l6i)
- [Dev.to/JS] [Solid Design Principles In Javascript &lpar;Part 1&rpar; — Single Responsibility Principle](https://dev.to/calebmantey/solid-design-principles-in-javascript-part-1-single-responsibility-principle-4k0c)
