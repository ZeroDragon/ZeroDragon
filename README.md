...
- [Dev.to/JS] [TIL beginner Javascript](https://dev.to/angelarosptvo/til-beginner-javascript-54dj)
- [Dev.to/JS] [Why do I need to use reduce method in Javascript](https://dev.to/nikolasbarwicki/why-do-i-need-to-use-reduce-method-in-javascript-4kgk)
