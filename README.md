...
- [Dev.to/JS] [Paracetamol.js💊| #36: Explica este código JavaScript](https://dev.to/duxtech/paracetamoljs-36-explica-este-codigo-javascript-emd)
- [Dev.to/JS] [Always provide customer value](https://dev.to/tkdodo/always-provide-customer-value-4g2f)
- [Dev.to/JS] [Road to Refactoring](https://dev.to/tkdodo/road-to-refactoring-4ep7)
- [Dev.to/JS] [O início](https://dev.to/ray_silva/o-inicio-3lo7)
