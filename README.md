...
- [Dev.to/JS] [How to do CSS like transitions in Svelte?](https://dev.to/akuks/how-to-do-css-like-transitions-in-svelte-1j8h)
- [Dev.to/JS] [How to become a web developer in 2021 | web developer salary | All-time-dev](https://dev.to/codingland/how-to-become-a-web-developer-in-2021-web-developer-salary-all-time-dev-ean)
- [Dev.to/JS] [Add storybook.js to a sveltekit project](https://dev.to/kiranojhanp/add-storybookjs-to-a-sveltekit-project-40n5)
- [Dev.to/JS] [An Updated &lpar;per January-2022&rpar; Vuejs v3 App on Amplify, AppSync, and Cognito](https://dev.to/adron/an-updated-per-january-2022-vuejs-v3-app-on-amplify-appsync-and-cognito-4555)
- [Dev.to/JS] [Java vs JavaScript | Detailed comparison | All-time-dev](https://dev.to/codingland/java-vs-javascript-detailed-comparison-all-time-dev-52fb)
- [Dev.to/JS] [The Only stock resources library you will ever need.](https://dev.to/visualway/the-only-stock-resources-library-you-will-ever-need-1431)
