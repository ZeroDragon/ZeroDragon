...
- [Dev.to/JS] [Hello world in nodeJS](https://dev.to/nermineslimane/hello-world-in-nodejs-35lm)
- [Dev.to/JS] [10 Popular JavaScript methods implemented from scratch](https://dev.to/northwillov/10-popular-javascript-methods-implemented-from-scratch-1ohk)
- [Dev.to/JS] [Leetcode diary: 1395. Count Number of Teams [DP problem]](https://dev.to/kevin074/leetcode-diary-1395-count-number-of-teams-dp-problem-2l1e)
- [Dev.to/JS] [Top 10 trending github repos for JavaScript developers in this week🐵.](https://dev.to/ksengine/top-10-trending-github-repos-for-javascript-developers-in-this-week-289m)
- [Dev.to/JS] [Incremental Static Regeneration &lpar;ISR&rpar; com Nextjs](https://dev.to/andersonsilva019/incremental-static-regeneration-isr-com-nextjs-m6d)
- [Dev.to/JS] [How to write performant React code: rules, patterns, do&#39;s and don&#39;ts](https://dev.to/adevnadia/how-to-write-performant-react-code-rules-patterns-dos-and-donts-40gk)
- [Dev.to/JS] [My 2nd Project | Day 7](https://dev.to/developerioweb/my-2nd-project-day-7-3g16)
