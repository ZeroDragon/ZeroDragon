...
- [Dev.to/JS] [Why React+Django is the most preferred in 2022?](https://dev.to/techmaniacc/why-reactdjango-is-the-most-preferred-in-2022-55pm)
- [Dev.to/JS] [How to create reliable and scalable frontend applications](https://dev.to/this-is-learning/how-to-create-reliable-and-scalable-frontend-applications-5578)
- [Dev.to/JS] [ReactJS all hooks series: UseReducer in action.](https://dev.to/amiinequ/reactjs-all-hooks-series-usereducer-in-action-360m)
- [Dev.to/JS] [8. IIFE, Modules, and Namespaces](https://dev.to/sungjuneun/8-iife-modules-and-namespaces-53p5)
