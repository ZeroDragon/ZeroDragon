...
- [Dev.to/JS] [OSD700: Maintaining Telescope](https://dev.to/beamazedvariable/osd700-maintaining-telescope-397f)
- [Dev.to/JS] [Deep dive into React codebase [EP2: What package from the repo is the most popular on npm?]](https://dev.to/fromaline/deep-dive-into-react-codebase-ep2-what-package-from-the-repo-is-the-most-popular-on-npm-2328)
- [Dev.to/JS] [Making Gmail Notification Extensions without logging in: A Step By Step Guide](https://dev.to/midhunz/making-gmail-notification-extensions-without-logging-in-a-step-by-step-guide-160b)
