...
<!-- TECH-POSTS:START -->
- [Dev.to/JS] [What are Web Vitals?](https://dev.to/dreamyplayer/what-are-web-vitals-482p)
- [Dev.to/JS] [How to get myself to read books](https://dev.to/joshchu/how-to-get-myself-to-read-books-2841)
...
- [Dev.to/JS] [🚀10 Trending projects on GitHub for web developers - 4th March 2022](https://dev.to/iainfreestone/10-trending-projects-on-github-for-web-developers-4th-march-2022-895)
- [Dev.to/JS] [5 packages to level up your React code](https://dev.to/geektechpub/5-packages-to-level-up-your-react-code-519d)
- [Dev.to/JS] [Paracetamol.js💊| #70: Explica este código JavaScript](https://dev.to/duxtech/paracetamoljs-70-explica-este-codigo-javascript-4lfj)
- [Dev.to/JS] [Svelte - The First Four Magic Words](https://dev.to/krowemoh/svelte-the-first-four-magic-words-3l84)
- [Dev.to/JS] [Review Template Blog Mas Sugeng](https://dev.to/belajarblogseo/review-template-blog-mas-sugeng-4m49)
- [Dev.to/JS] [Protractor Testing Tutorial: Test Automation with Protractor and Selenium](https://dev.to/garima_writes/protractor-testing-tutorial-test-automation-with-protractor-and-selenium-33mf)
