...
- [Dev.to/JS] [NestJS Dependency Injection - Overview](https://dev.to/shameel/nestjs-dependency-injection-overview-29h3)
- [Dev.to/JS] [Database transactions in node](https://dev.to/akmaurya31/database-transactions-in-node-3d5n)
