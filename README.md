...
- [Dev.to/JS] [React Tips &amp; Patterns](https://dev.to/santan21/react-tips-patterns-3i8k)
- [Dev.to/JS] [Can a man become a starship? Yes, in TypeScript. A guide to structural and nominal typing](https://dev.to/emphie/can-a-man-become-a-starship-yes-in-typescript-a-guide-to-structural-and-nominal-typing-9ao)
