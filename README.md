...
- [Dev.to/JS] [Top 10+ Angular Libraries for Your Next Web App](https://dev.to/flatlogic/top-10-angular-libraries-for-your-next-web-app-21hc)
- [Dev.to/JS] [Moonly weekly progress update #31](https://dev.to/moonly/moonly-weekly-progress-update-31-5hch)
- [Dev.to/JS] [Binding event handlers in React](https://dev.to/thecodess/binding-event-handlers-in-react-2d34)
