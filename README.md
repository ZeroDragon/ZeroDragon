...
- [Dev.to/JS] [Upcoming ECMAScript features I&#39;m excited about](https://dev.to/janis_t/upcoming-ecmascript-features-im-excited-about-pba)
- [Dev.to/JS] [Web Developer Full Course : Client Server Architecture, Static and Dynamic Websites - #2](https://dev.to/prateek951/web-developer-full-course-client-server-architecture-static-and-dynamic-websites-2-3aoe)
- [Dev.to/JS] [Responsive Education Website Using Html CSS JavaScript](https://dev.to/codewithsadee/responsive-education-website-using-html-css-javascript-3mpe)
