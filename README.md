...
- [Dev.to/JS] [Race Condition Fallacies of `Promise.all`](https://dev.to/domiii/the-dangling-fallacy-with-promiseall-543n)
- [Dev.to/JS] [Vue.js #1: Introduction](https://dev.to/ericnanhu/vuejs-1-introduction-547g)
- [Lifehacker] [How to Roll a Perfect Joint](https://lifehacker.com/how-to-roll-a-perfect-joint-1848559512)
- [Dev.to/JS] [Difference between const, var and let in JS](https://dev.to/bellatrix/difference-between-const-var-and-let-in-js-bn8)
- [Dev.to/JS] [Vue.js For Beginners](https://dev.to/ericnanhu/vuejs-for-beginners-3pe9)
