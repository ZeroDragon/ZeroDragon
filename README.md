...
- [Dev.to/JS] [How to Download Facebook videos](https://dev.to/masterofastro/how-to-download-facebook-videos-1nng)
- [Dev.to/JS] [How to get query string parameters from the URL in Next.js](https://dev.to/calvin087/how-to-get-query-string-parameters-from-the-url-in-nextjs-3kdc)
- [Dev.to/JS] [Weekly web development resources #127](https://dev.to/vincenius/weekly-web-development-resources-127-4bea)
- [Dev.to/JS] [Next.js Loads script tags but it doesn&#39;t execute them](https://dev.to/calvin087/nextjs-loads-script-tags-but-it-doesnt-execute-them-4nda)
- [Dev.to/JS] [How to reverse an array in JavaScript](https://dev.to/devmaradona/how-to-reverse-an-array-in-javascript-248j)
- [Dev.to/JS] [Why using just console.log in 2023 is a big no-no 🚀](https://dev.to/naubit/why-using-just-consolelog-in-2023-is-a-big-no-no-2429)
- [Dev.to/JS] [#newbie](https://dev.to/siddikshaikh786/newbie-318f)
