...
- [Dev.to/JS] [The useEffect hook in React 18 has a peculiar behavior.](https://dev.to/khansa/the-useeffect-hook-in-react-18-has-a-peculiar-behavior-4oef)
...
- [Dev.to/JS] [Static Site using Nuxt.js with Storyblok CMS](https://dev.to/silogecho97/static-site-using-nuxtjs-with-storyblok-cms-7ac)
