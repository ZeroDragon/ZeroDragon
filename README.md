...
- [Dev.to/JS] [What is a Factory Design Pattern? It Is For You!](https://dev.to/hosseinmobarakian/what-is-a-factory-design-pattern-it-is-for-you-1ka6)
- [Dev.to/JS] [Building a Real-Time Online Status Checker with React using useSyncExternalStore](https://dev.to/sharmaprash/building-a-real-time-online-status-checker-with-react-using-usesyncexternalstore-5k0)
