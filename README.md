...
<!-- TECH-POSTS:START -->
- [Dev.to/JS] [Frontend Mentor - REST Countries API with color theme switcher](https://dev.to/nabillatrisnani/frontend-mentor-rest-countries-api-with-color-theme-switcher-510n)
...
- [Dev.to/JS] [4.2 Getting Professional with Firebase V9 - Creating a Backup system](https://dev.to/mjoycemilburn/42-getting-professional-with-firebase-v9-creating-a-backup-system-25gd)
- [Dev.to/JS] [Top 10 array methods to learn to become a pro in JavaScript](https://dev.to/thatanjan/top-10-array-methods-to-learn-to-become-a-pro-in-javascript-1ic9)
- [Dev.to/JS] [Some mistakes with async and promise in Javascript](https://dev.to/trunghieu99tt/some-mistakes-with-async-and-promise-in-javascript-1fa8)
...
- [Dev.to/JS] [Professional Git Workflow &amp; GitHub Setup for &lpar;React&rpar; Developers &lpar;including screencast&rpar;](https://dev.to/profydev/professional-git-workflow-github-setup-for-react-developers-pfj)
