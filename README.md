...
<!-- TECH-POSTS:START -->
- [Dev.to/JS] [How Authentication works in REST APIs ?](https://dev.to/thenerdydev/how-authentication-works-in-rest-apis--3enb)
- [Dev.to/JS] [Load or set environment variables in Node.js without dotenv or any third package.](https://dev.to/sktanwar2014/load-or-set-environment-variables-in-nodejs-without-dotenv-or-any-third-package-6io)
- [Dev.to/JS] [The hidden scope of a named function expression](https://dev.to/smlka/the-hidden-scope-of-a-named-function-expression-4hc5)
- [Dev.to/JS] [WebScrapperJS - Get Content/HTML of any website without being blocked by CORS even using JavaScript by WhollyAPI](https://dev.to/sh20raj/webscrapperjs-get-contenthtml-of-any-website-without-being-blocked-by-cors-even-using-javascript-by-whollyapi-42l7)
- [Dev.to/JS] [One Way to Cheat Wordle using Javascript](https://dev.to/ozboware/one-way-to-cheat-wordle-using-javascript-1l71)
- [Dev.to/JS] [Building Video Chat App with VueJs and Golang](https://dev.to/100mslive/building-video-chat-app-with-vuejs-and-golang-2367)
- [Dev.to/JS] [Scroll  event on div in reacjts](https://dev.to/mohsinalisoomro/scroll-event-on-div-in-reacjts-552d)
- [Dev.to/JS] [Creating my personal website with Astro, Tailwind CSS, and Nx](https://dev.to/leosvelperez/creating-my-personal-website-with-astro-tailwind-css-and-nx-149a)
- [Dev.to/JS] [Cryptocurrency MLM software - An unique way of promoting your crypto coins:](https://dev.to/johngamly/cryptocurrency-mlm-software-an-unique-way-of-promoting-your-crypto-coins-1jjf)
- [Dev.to/JS] [Should I Learn Double Language like&lpar;C++ &amp; Java&rpar;,&lpar;Java+ Java-script&rpar;or&lpar;Java-script and C++&rpar;?](https://dev.to/tamal1912/should-i-learn-double-language-likec-javajava-java-scriptorjava-script-and-c-23jn)
