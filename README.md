...
- [Dev.to/JS] [Repository Pattern with Typescript, Node.js and native PostgreSQL driver](https://dev.to/fyapy/fully-featured-repository-pattern-with-typescript-and-native-postgresql-driver-4f2j)
